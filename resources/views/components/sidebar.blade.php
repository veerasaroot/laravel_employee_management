                ...
                <ul class="pb-2 space-y-2">
                    ...
                    <li>
                        ...
                        <ul id="dropdown-crud" class="space-y-2 py-2 crud hidden">
                            <li>
                                <a href="" class="text-base text-gray-900 rounded-lg flex items-center p-2 group hover:bg-gray-100 transition duration-75 pl-11 dark:text-gray-200 dark:hover:bg-gray-700 products bg-gray-100 dark:bg-gray-700">Products</a>
                            </li>
                            <li>
                                <a href="" class="text-base text-gray-900 rounded-lg flex items-center p-2 group hover:bg-gray-100 transition duration-75 pl-11 dark:text-gray-200 dark:hover:bg-gray-700 users bg-gray-100 dark:bg-gray-700">Users</a>
                            </li>
                        </ul>
                    </li>
                    <li>
                        <a href="" class="flex items-center p-2 text-base text-gray-900 rounded-lg hover:bg-gray-100 group dark:text-gray-200 dark:hover:bg-gray-700 settings bg-gray-100 dark:bg-gray-700">
                    ...
                    <li>
                        ...
                        <ul id="dropdown-playground" class="space-y-2 py-2 playground hidden">
                            <li>
                                <a href="" class="text-base text-gray-900 rounded-lg flex items-center p-2 group hover:bg-gray-100 transition duration-75 pl-11 dark:text-gray-200 dark:hover:bg-gray-700 stacked bg-gray-100 dark:bg-gray-700">Stacked</a>
                            </li>
                            <li>
                                <a href="" class="text-base text-gray-900 rounded-lg flex items-center p-2 group hover:bg-gray-100 transition duration-75 pl-11 dark:text-gray-200 dark:hover:bg-gray-700 sidebar bg-gray-100 dark:bg-gray-700">Sidebar</a>
                            </li>
                        </ul>
                    </li>
                </ul>
